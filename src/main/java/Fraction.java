public class Fraction implements IFraction {
    ...
    public IFraction plus(IFraction other) {
        int nom = denominator;
        nom = findLowestCommonMultiple(denominator,other.getDenominator());
        return createNormalised(numerator*(nom/denominator)+(other.getNumerator()*(nom/other.getDenominator())),findLowestCommonMultiple(denominator,other.getDenominator()));
        }
